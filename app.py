...
if st.session_state["menu_activo"] == "🏠 Dashboard":
    ...
    with col_btn1:
        st.download_button(label="📥 Download Personalized Clinical Report", data=reporte_pdf_contenido, file_name=f"Methylox_Report_{patient_id}.pdf", use_container_width=True)
            if patient_id:
