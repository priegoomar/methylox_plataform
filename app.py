...
# 2. MOTOR DE ANIMACIÓN 3D ROTATIVA MAESTRA SOBRE TU IMAGEN REAL
st.markdown("""<style>
    ...
    .enterprise-card-banner {
        ...
        width: 100%;
        position: relative;
        perspective: 1000px; /* Activa el espacio tridimensional */
        animation: premium3DFlipRotation 12s linear infinite;
    }
    
    /* Efecto Tecnológico: Volteo y rotación continua en el eje Y (360 Grados) */
    @keyframes premium3DFlipRotation {
        0% { transform: rotateY(0deg); filter: brightness(1); }
        50% { transform: rotateY(180deg); filter: brightness(1.03) saturate(1.05); }
...
with tab_clinico:
    # EL LIENZO DESPLIEGA TU IMAGEN ROTANDO EN 3D REAL
